...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/10/12 20:37:12 by alancel           #+#    #+#             */
/*   Updated: 2021/10/12 20:50:07 by alancel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	*check_runtime(void *data)
{
	...
	{
		if ((philo->status != 'E' && get_time() - philo->last_eat
				> g_opts.time_to_die) || philo->alive)
		{
			philo->status = 'D';
			print(philo);
